...
//Sorulara fotoğraf ve video ekleme 
    ...
    let video="";
    let Soru;
    if (questions[index].soru_num === 5) {
        photo = `
        <img class='answer-image' src='https://ogmmateryal.eba.gov.tr/panel/upload/soru/d33rcpitgji.png'>` 
        Soru = '<span>'+ questions[index].soru_num + ". " + questions[index].question +'<br>'+ photo +'</span>';
    }else if(questions[index].soru_num === 0) {
